...
function add_course() {
	...
	var savecourse = document.getElementById("savecourse").value;
...
function allocate_course() {
    ...
    var levelid = document.getElementById("levelid").value;
    var semesterid = document.getElementById("semesterid").value;
	var allocatecourse = document.getElementById("allocatecourse").value;
...
if (staffid != "") {
    ...
    alert("Select Lecturer to allocate course");
}
}
else{
    alert("Select Course to allocate");
}
}